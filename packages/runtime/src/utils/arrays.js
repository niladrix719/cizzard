...
class ArrayWithOriginalIndices {
  ...
  noopItem(index) {
    const operations = {
      ...
      originalIndex: this.orginialIndexAt(index),
      index,
      item: this.#array[index]
    }
  ...
  moveItem(item, toIndex) {
    ...
    const operation = {
      ...
      originalIndex: this.orginialIndexAt(fromIndex),
      from: fromIndex,
      index: toIndex,
